...
function Competitions({ embedded = false }) {
 ...
 className="inline-flex items-center justify-center gap-3 rounded-[50px] border border-[#D4AF37]/70 bg-gold-gradient px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-black transition-all duration-300 hover:brightness-110 md:text-sm cursor-pointer"
 >
 View Details
