        ...
        <main className="mx-auto flex w-full max-w-[1180px] flex-col justify-center px-[clamp(16px,4vw,40px)]">
          {events.map((event, i) => (
            ...
            >
              ...
              <div ref={eventImageRef} className="relative order-2 mt-4 md:mt-0 w-full max-w-[240px] md:max-w-[300px] mx-auto border border-sky-500/40 bg-black/40 p-2 backdrop-blur-sm md:col-start-2 md:row-start-1 md:row-span-2 shadow-[0_0_40px_rgba(56,189,248,0.2)]" style={{ opacity: 0 }}>
              ...
              <div className="order-3 mt-4 md:mt-0 md:col-start-1 md:row-start-2">
                <button
                  ...
                  className="inline-block border border-sky-400 bg-sky-500/10 px-8 py-2.5 text-xs uppercase tracking-[3px] text-sky-400 transition-all duration-200 hover:bg-sky-400 hover:text-black hover:shadow-[0_0_25px_rgba(56,189,248,0.5)] cursor-pointer"
                  style={{ opacity: 0 }}
                >
                  View Details
                </button>
