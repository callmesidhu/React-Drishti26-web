...
function Contact() {
  ...
  return (
    <div className="relative min-h-svh w-full overflow-hidden bg-[#050505] text-gold">
      ...
      {/* Header */}
      <header className="px-[clamp(16px,4vw,40px)] pt-[clamp(90px,10vw,120px)] text-center">
        <p className="text-[11px] uppercase tracking-[6px] text-gold/60">Get In Touch</p>
        <h1
          ref={h1Ref}
          className="mt-2 text-[clamp(44px,8vw,100px)] font-bold uppercase leading-none tracking-tight"
        ...
        <p
          ref={subheadRef}
          className="mt-3 text-[clamp(13px,2vw,18px)] uppercase tracking-[4px] text-white/70"
      ...
      <main className="mx-auto mt-12 max-w-[1240px] px-[clamp(16px,4vw,40px)] pb-24">
        <div className="grid items-stretch gap-8 lg:grid-cols-12 lg:gap-12">
          {/* Left Column: Direct Contact Info */}
          <div ref={leftColRef} className="flex flex-col justify-between gap-6 lg:col-span-5">
            {/* Convenor Card */}
            <div className="relative rounded-2xl border border-gold/25 bg-black/60 p-7 backdrop-blur-xl transition-all duration-300 hover:border-gold/50 shadow-[0_0_40px_rgba(0,0,0,0.6)]">
              ...
              <h2
                className="mt-3 text-2xl font-bold uppercase tracking-wider text-white"
              ...
              <a
                ...
                className="mt-2 inline-block font-mono text-lg font-semibold text-gold transition-colors duration-200 hover:text-white"
              >
                +91 85905 40376
              </a>
            ...
            <div className="relative rounded-2xl border border-gold/25 bg-black/60 p-7 backdrop-blur-xl transition-all duration-300 hover:border-gold/50 shadow-[0_0_40px_rgba(0,0,0,0.6)]">
              ...
              <h2
                className="mt-3 text-lg font-bold uppercase tracking-wider text-white"
                style={{ fontFamily: "'Bietro DEMO-Regular', 'Bietro DEMO', sans-serif" }}
              >
              ...
              <a
                ...
                className="mt-2 inline-block text-lg font-semibold text-gold transition-colors duration-200 hover:text-white"
              >
                drishti@cet.ac.in
              </a>
          ...
          <div
            ref={rightColRef}
            className="relative flex flex-col rounded-2xl border border-gold/30 bg-black/80 p-4 backdrop-blur-2xl lg:col-span-7 shadow-[0_0_60px_rgba(0,0,0,0.8)]"
          >
            {/* Luminous Reticles */}
            ...
            <div className="mb-3 flex items-center justify-between border-b border-white/10 px-3 pb-3 pt-1">
            ...
            <div className="relative min-h-[420px] flex-1 overflow-hidden rounded-xl border border-white/15 bg-[#0a0a0a]">
              <iframe
