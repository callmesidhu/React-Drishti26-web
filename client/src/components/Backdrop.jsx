      ...
      <svg ref={gridRef} className="absolute inset-0 h-full w-full opacity-[0.14] mix-blend-screen" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id={isBlue ? "brutalist-grid-blue" : "brutalist-grid"} width="60" height="60" patternUnits="userSpaceOnUse">
            <path d="M 60 0 L 0 0 0 60" fill="none" stroke="currentColor" strokeWidth="0.75" className={isBlue ? "text-sky-400" : "text-gold"} />
            <path d="M 57 60 H 63 M 60 57 V 63" fill="none" stroke="currentColor" strokeWidth="0.8" className={isBlue ? "text-sky-400" : "text-gold"} />
          </pattern>
        </defs>
